...
/**
 * Created by Ccb on 2015/8/25.
 */
public class MyFragmentViewPagerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
    ...
    public MyFragmentViewPagerAdapter(FragmentManager fragmentManager, ViewPager viewPager, List<Fragment> fragments, List<String> mTitles) {
