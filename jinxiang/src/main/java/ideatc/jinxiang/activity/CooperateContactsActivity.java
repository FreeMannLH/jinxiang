...
/**
 * @author ccb
 * create at 2015/9/18 10:20
 */
public class CooperateContactsActivity extends ToolBarBaseActivity {
    ...
    private CooperateChanceDetailBean.CooperateModel.ContactsEntity contactsEntity;
    @Override
    ...
    public void initData() {
        if (contactsEntity.getIsMain()) mCheckBox.setChecked(true);
