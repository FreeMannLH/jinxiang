...
public class SegmentControl extends View {
    ...
    private boolean inTapRegion = true;
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle) {
        ...
        mDirection = Direction.values()[ta.getInt(R.styleable.SegmentControl_directions, 0)];
    ...
    public void setOnSegmentControlClickListener(OnSegmentControlClickListener onSegmentControlClickListener) {
        ...
        mOnSegmentControlClickListener.onSegmentControlClick(mCurrentIndex);
    }
